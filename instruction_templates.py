...
def get_instructions(text=None, options=None, region=None, context=None, question=None, explanation=None, response=None, premise=None, hypothesis=None, answer=None, meta_data=None, target=None, use_natural=False, instruction_id=-1):
    # if options:
    ...
    # task_instruction_mapping["image_caption"] = [
    ...
    # task_instruction_mapping["open-domain_VQA"] = [
    #         f"""{question}""",
    #         f"""{question}""",
    #         f"""{question}""",
    #         f"""{question}""",
    ...
    # task_instruction_mapping["GC_selection"] = [
    ...
    # task_instruction_mapping["VG_selection"] = [
    ...
    # task_instruction_mapping["object_grounding"] = [
    ...
    # task_instruction_mapping["object_region_match"] = [
    ...
    # task_instruction_mapping["object_match"] = [
    ...
    # task_instruction_mapping["question_image_match"] = [
    ...
    # task_instruction_mapping["object_region_selection"] = [
    ...
    #     ]
    # # modify
    # task_instruction_mapping["missing_object_selection"] = [f"""Select objects that do not appear in any of {region_split_token.join(region)}. Select "None" if you can't find any.{options_token} {split_token.join(options)}""",
    ...
    # task_instruction_mapping["ITM"] = [f"""Does \"{text}\" describes image? {options_token} {split_token.join(options)}""",
    ...
    #     ]
    # # modify    
    # task_instruction_mapping["region_object_selection"] = [f"""Select objects from the options that appear in at least one of the regions. Select "None" if you can't find it.{region_token} {region_split_token.join(region)}. {options_token} {split_token.join(options)}""",
    ...
    # task_instruction_mapping["region_generation"] = [f"""What are the regions contain the object \"{text}\"?""",
